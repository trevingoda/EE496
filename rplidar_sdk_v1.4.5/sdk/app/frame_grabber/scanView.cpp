...
const float DISP_FULL_DIST   = 7000;
...
CScanView::CScanView()
{
    ...
    _current_display_range = DISP_FULL_DIST;
...
void CScanView::setScanData(rplidar_response_measurement_node_t *buffer, size_t count, float frequency)
{
    _scan_data.clear();
