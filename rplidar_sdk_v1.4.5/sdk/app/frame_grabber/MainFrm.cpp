...
void    CMainFrame::onRefreshScanData()
{
    ...
    {
		float frequency = 0;
		lidar_drv->getFrequency(nodes, cnt, frequency);
		m_scanview.setScanData(nodes, cnt, frequency);
    }
}
...
void    CMainFrame::onUpdateTitle()
{
    ...
    rplidar_response_device_info_t & devinfo = LidarMgr::GetInstance().devinfo;
    ...
    case WORKING_MODE_SCAN:
        {
            ...
            checkDeviceHealth();
            LidarMgr::GetInstance().lidar_drv->startScan(forcescan);
